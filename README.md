...
- Tri insertion :
    ...
    Le tri insertion est extrêmement efficace pour les tableaux croissants et constants mais vraiment très lent pour le reste. Ainsi on le testeras sur des tableaux suivants :
...
- Mélanges hétérogènes :
 ...
 - Mélanges hétérogènes :
     ...
     La différence de temps d'exécution du tri fusion est très faible par rapport à celui des deux autres. Cela pourrait s'expliquer notamment par le fait que les partitions de tri fusion prennent du temps en termes de copie des valeurs dans les nouveaux tableaux.
